...
EASY_OCR = easyocr.Reader(['en', 'id'], gpu=True) ### initiating easyocr
OCR_TH = 0.2
...
def recognize_plate_easyocr(img, coords,reader,region_threshold):
	...
	# cv2.imwrite("final_output/cropped-img.jpg",nplate)
	# TODO: add preprocessing for OCR here

	ocr_result = reader.readtext(nplate, paragraph=True)
	# print(f'------ini text{ocr_result[0][1]}')
...
def main(img_path=None, vid_path=None, vid_out = None):
	...
	model =  torch.hub.load('WongKinYiu/yolov7', "custom", 'plat-tiny-v2.pt', trust_repo=True) ### The repo is stored locally
	# model = custom(path_or_model='plat-tiny-v2.pt')
...
main(img_path="./test_images/img12.jpg") ## for image
